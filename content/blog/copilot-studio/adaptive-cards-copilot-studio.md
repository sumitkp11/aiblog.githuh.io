...
- DATE syntax: `{% raw %}{{DATE(<date>|<date-time>[,COMPACT|SHORT|LONG])}}{% endraw %}`

- TIME syntax: `{% raw %}{{TIME(<time>|<date-time>)}}{% endraw %}`
...
#### Examples
1. Compact date: `{% raw %}{{DATE(2017-02-14T06:00:00Z)}}{% endraw %}` -> 14/2/2017
2. Short date: `{% raw %}{{DATE(2017-02-14T06:00:00Z,SHORT)}}{% endraw %}` -> Tue, 14 Feb, 2017
